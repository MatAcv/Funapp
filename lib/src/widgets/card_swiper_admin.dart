...
class CardSwiperAdmin extends StatelessWidget {

       List<dynamic> denunciass = new List();
       final List<Denuncia> denuncias;
       String poster = '';
       
  CardSwiperAdmin({@required this.denuncias});
   ...
   poster= d.getPoster();
    ...
    return Container(
      ...
      return   GestureDetector(
         ...
         Navigator.pushNamed(context, 'denunciaDetalleAdmin', arguments : denuncias[index]);
